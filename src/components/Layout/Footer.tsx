...
const Footer = () => {
  ...
  <img
  src={Logo}
  alt="Aachman Ayurveda Logo"
  className="h-20 w-22 rounded-xl object-cover"
/>

      <h3 className="font-serif text-2xl font-bold">Aachman Ayurveda</h3>
  </div>
  <p className="text-white/80 max-w-md">
    Aachman Ayurveda brings you time-tested Ayurvedic solutions crafted with pure herbs to support your wellness journey — naturally and holistically.
  </p>
</div>
